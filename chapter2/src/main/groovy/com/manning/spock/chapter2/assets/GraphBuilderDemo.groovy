...
AssetInventory shipRegistry = builder.assetInventory() {
	...
	ship ( name: "Calypso I", destination:"Bristol") {
		crewMember(firstName:"Eric", lastName:"Folkes",age:43)
		crewMember(firstName:"Louis", lastName:"Lessard",age:28)
	...
	{
		crewMember(firstName:"Michelle", lastName:"Kindred",age:43)
		crewMember(firstName:"Kathy", lastName:"Parker",age:28)
